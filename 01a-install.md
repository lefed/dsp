...
>> Python 3 as it was the recommended version and I am curious to understand how it is different from Python 2.

### Q2. Which Python Version Installed   

How can you check the version of Python installed if you happen to be on an unfamiliar computer?

>> In terminal check version using 'python --version'
